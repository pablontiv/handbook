...
La publicación a archivo queda protegida por raíces prohibidas completas sin contaminar `BuildPlan` con efectos ambientales. Esto conserva la frontera pura para aprobación y concentra la seguridad de salida en el adaptador que ya posee las garantías de publicación absoluta, no-follow y no-replace.
