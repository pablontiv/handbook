...
- **Patterns**: Does it follow existing codebase conventions? (Check CLAUDE.md, project rules)
...
- Project governance and conventions (CLAUDE.md)
...
- **Project context**: Read CLAUDE.md and project rules for conventions specific to this repository.
...
5. Your plain final text does NOT reach the parent. For parent-visible delivery, deliver via SendMessage to
   "main".
